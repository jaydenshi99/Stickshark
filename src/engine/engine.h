...
class Engine {
    ...
    int16_t negaMax(int depth, int16_t alpha, int16_t beta, int16_t turn, int remainingCheckExtensions, bool isRoot = false);    // Sets bestMove to the best move and sets moveEval to the eva

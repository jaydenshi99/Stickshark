...
void calculatePieceSquareTables() {
    for (int i = 0; i < 64; i++) {
        ...
        pieceSquareTablesMG[WPAWN][i] = mg_pawn_table[flippedRow * 8 + flippedCol];
        pieceSquareTablesEG[WPAWN][i] = eg_pawn_table[flippedRow * 8 + flippedCol];
        pieceSquareTablesMG[WBISHOP][i] = mg_bishop_table[flippedRow * 8 + flippedCol];
        pieceSquareTablesEG[WBISHOP][i] = eg_bishop_table[flippedRow * 8 + flippedCol];
        pieceSquareTablesMG[WKNIGHT][i] = mg_knight_table[flippedRow * 8 + flippedCol];
        pieceSquareTablesEG[WKNIGHT][i] = eg_knight_table[flippedRow * 8 + flippedCol];
        pieceSquareTablesMG[WROOK][i] = mg_rook_table[flippedRow * 8 + flippedCol];
        pieceSquareTablesEG[WROOK][i] = eg_rook_table[flippedRow * 8 + flippedCol];
        pieceSquareTablesMG[WQUEEN][i] = mg_queen_table[flippedRow * 8 + flippedCol];
        pieceSquareTablesEG[WQUEEN][i] = eg_queen_table[flippedRow * 8 + flippedCol];
